                            ...
                            <tr>
                                <td align="left" valign="middle" style="padding: 0px 12px 0px 12px">
                                    <a href="http://queenbohemia.ru" style="display: block;width: 100%;height: 100%;">
                                        <img src="https://queenbohemia.ru/image/mail/logo.png" alt="Queen of Bohemia"
                                            width="253px" height="35px"
                                            style="display: block;width: 253px;height: 35px;">
                                    </a>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <table width="624px" cellpadding="0" border="0" cellspacing="0" align="center"
                                        valign="top" style="table-layout:auto;border-collapse:collapse">
                                        <tbody>
                                            <tr>
                                                <td style="padding:0px 12px 0px 12px">
                                                    <table width="auto" cellpadding="0" border="0" cellspacing="0"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td align="left" valign="top"
                                                                    ...
                                                                    <img src="https://queenbohemia.ru/image/mail/handshake.png"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    Мы рады видеть вас в числе зарегистрированных пользователей сайта <a href="https://queenbohemia.ru">queenbohemia.ru</a>
                                                                    <br><br>
                                                                    Воспользуйтесь всеми преимуществами доступными для Вас:
                                                                    отслеживайте статус доставки, историю заказов, сохраняйте понравившиеся товары навсегда!
                                                                </td>
                                                            </tr>
                                                            <!-- <tr>
