          ...
          <div className="container help__cont">
            <div className="row">
              <div className="col col-8 col-t-7 col-s-12 help__desc">
                <h3>О нас</h3>
                <p>
                  Queen of Bohemia — сеть магазинов оригинальной Богемии. Мы предлагаем большой выбор посуды и подарков из богемского стекла, хрусталя и фарфора нашим покупателям с 1992 года. Мы знаем всё о знаменитом богемской стекле, хрустале и карловарском фарфоре и предложим нашему покупателю только лучшее!
                </p>
                <p>
                  Покупайте изделия всемирно известных Чешских производителей в уютном и с любовью созданном магазине, когда и где вам удобно. Прямые закупки на заводах и фабриках в Чехии и других странах Европы  позволяют нам предлагать нашим  покупателям  низкие цены и постоянно обновляющиеся коллекции. Постоянно проводимые акции и распродажи порадуют вас приятными скидками и доступными ценами. Вся предлагаемая продукция оригинальная, имеет сертификаты соответствия производителя и обладает заводской гарантией.  
                </p>
                <p>
                  Чтобы ознакомиться с продукцией, перейдите в каталог или посмотрите специально для вас подготовленные коллекции, акции и идеи. В разделе подарки наши покупатели смогут воспользоваться удобной формой поиска  и подобрать подарки  к торжеству в комфортном для себя бюджете.  Если у вас остались вопросы, {" "}
                  <span className="dib">
                    <a href="" className="link dotted" onClick={() => {
                      document
