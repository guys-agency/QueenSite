...
const CardView = observer(
    class CardView extends Component {
        ...
        clickHandler = (e) => {
            this.props.store.productInCartList = localStorage.get(
                'productInCart'
            )
        ...
        render() {
            ...
            if (this.data.slug === +this.props.sku && this.count) {
                if (
                    ...
                    api.timeDelivery({ data: dataDeliv })
                        .then((ok) => {
                            // console.log("ok :>> ", ok);
                            ok.forEach((del) => {
            ...
            if (this.data.slug === +this.props.sku) {
                ...
                this.inCart = Object.keys(this.props.store.productInCartList)
                    .length
                    ? Object.keys(this.props.store.productInCartList).indexOf(
                          String(this.data.slug)
                      )
            ...
            if (Object.keys(lastSeenProdsData).length) {
                lastSeenProdsRender = Object.keys(lastSeenProdsData).map(
                    (el, i) => {
                        ...
                        <div className="container">
                            <div>
                                ...
                                <button
                                    ...
                                    onClick={this.close}
                                >
                                    <span className="ic i_left"></span>{' '}
                                    Вернуться назад
                                </button>
                                <div
                                    className={
                                        'row product-p ' +
                                        (this.data.description ? '' : 'no-desc')
                                    }
                                >
                                            ...
                                            {itsSert ? (
                                                <>
                                                    <p className="product-p__info">
                                                        ...
                                                        отличный и модный
                                                        подарок , когда есть
                                                        повод, а вы не знаете,
                                                        что подарить. Подарите
                                                        ...
                                                        <br />
                                                        <br />
                                                        Ссылка на подарочную
                                                        страницу будет
                                                        сгенерирована сразу
                                                        после покупки и
                                                        продублируется вам на
                                                        почту.
                                                        <br />
                                                        <br />
                                                        <Link
