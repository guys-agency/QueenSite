    ...
    class CartPage extends Component {
        ...
        stores = {
            ...
            'ТРЦ Пушкино парк': {
                ...
                address:
                    'Московская область, Пушкино, Красноармейское шоссе, 1, 104',
        ...
        choosePaymentType = (e, type) => {
            ...
            Object.keys(productInCart).forEach((el, i) => {
                if (el !== certInCart) {
                    lengths.push(
                        parseInt(productInCart[el].dimensions.length, 10)
                    )
                    widths.push(
                        parseInt(productInCart[el].dimensions.width, 10)
                    )
                    heightSumm +=
                        parseInt(productInCart[el].dimensions.height, 10) *
                        productInCartList[el]
                    weightSumm +=
                        +productInCart[el].weight * productInCartList[el]
        ...
        render() {
            ...
            if (Object.keys(productInCart).length) {
                Object.keys(coupsCont).forEach((coupon) => {
                    coupRender.push(
                        <div key={coupsCont[coupon].code}>
                            {coupsCont[coupon].code.toUpperCase()} —{' '}
                            <p> Применён</p>{' '}
                            <button
                    ...
                    if (coupsCont[coupon].count > 0) {
                        if (coupsCont[coupon].type === 'percent') {
                            Object.keys(productInCart).forEach((el) => {
                                ...
                                const regPrice = typeIsPREPAID
                                    ? Math.floor(
                                          productInCart[el].regular_price * 0.98
                                      )
                                    : productInCart[el].regular_price
                                coupDisc +=
                                    Math.ceil(
                ...
                if (certInCart && productInCart[certInCart] !== undefined) {
                    if (
                        this.totalPrice -
                            productInCart[certInCart].regular_price >
                        coupDisc + certDisc
                    ) {
                ...
                <div className="cart-page">
                    ...
                    <div className="container">
                        <p>
                            ...
                            >
                                {' '}
                                <span className="ic i_left"></span> Вернуться в
                                магазин
                            </a>
                        </p>
                        <div className="row cart-page__wrp">
                            <div className="col col-7 col-s-12">
                              ...
                              <span className="disc_perc">-20%</span> */}
                                ...
                                <div className="cart-page__data">
                                    ...
                                    <form
                                        className="cart-page__data-form row"
                                        action=""
                                    >
                            ...
                            <div className="col col-4 col-s-12">
                                <div className="cart-page__result-stick">
                                    ...
                                    <div className="cart-page__result">
                                        ...
                                        <button
                                            ...
                                            onClick={(e) => {
                                                ...
                                                this.props.store.createOrderData(
                                                    this.state.payment
                                                )
                                                console.log(
                                                    'this.state.payment :>> ',
                                                ...
                                                const cityLoc = localStorage.get(
                                                    'city'
                                                )
                                                        ...
                                                        .then((data) => {
                                                            ...
                                                            if (
                                                                ...
                                                                const checkout = new window.YandexCheckout(
                                                                    {
                                                                        confirmation_token:
                                                                            data.confirmationToken, //Токен, который перед проведением оплаты нужно получить от Яндекс.Кассы
                                                                        return_url:
                                                                            data.return, //Ссылка на страницу завершения оплаты
                                    ...
                                    <div className="cart-page__coups">
                                        {coupRender}
                                    </div>
                ...
                if (el !== certInCart) {
                    items.push({
                        ...
                        dimensions: {
                            weight: +productInCart[el].weight,
                            length: parseInt(
                                productInCart[el].dimensions.length,
                                10
                            ),
                            width: parseInt(
                                productInCart[el].dimensions.width,
                                10
                            ),
                            height: parseInt(
                                productInCart[el].dimensions.height,
                                10
                            ),
                        },
                    })
            ...
            if (prodSumm !== this.totalPrice) {
                ...
                while (totalDeff > 0) {
                    if (i < items.length) {
                        if (items[i].price > 1) {
                            if (
                                items[i].price * items[i].count - totalDeff >
                                1
                            ) {
                                items[i].price = Math.floor(
            ...
            const start = () => {
                ...
                const successCallback = (widget) => {
                    ...
                    widget.on('submitDeliveryOption', (deliveryOption) => {
                        ...
                        this.setState({
                            deliveryData: { ...deliveryOption, time },
                        })
                    })
