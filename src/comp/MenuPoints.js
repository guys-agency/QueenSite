                ...
                .then((data) => {
                    ...
                    data.forEach((elem, i) => {
                        ...
                        elem.childs.sort((prev, next) => {
                            if (
                                prev.name.includes(' до ') &&
                                next.name.includes(' до ')
                            ) {
                                if (
                        ...
                        if (elem.name === 'Сервировка стола') {
                            ...
                            this.interier.push(
                                <ul key={elem.name}>{childsPoints}</ul>
                            )
                ...
                ></button> */}
                    ...
                    Бонусы
                                ...
                                <div
                                    ...
                                    onClick={(e) => {
                                        if (
                                            ...
                                            const cityData = localStorage.get(
                                                'city'
                                            )
                                            cityData.sourse = 'U'
                                            document
                                    ...
                                    <div className="header__drop header__drop_city-check">
                                        ...
                                        <div>
                                            <button
                                                ...
                                                onClick={() => {
                                                    $(
                                                        '.header__drop_city-check'
                                                    ).addClass('deactiv')
                                                    $(
                                                        '.header__drop_city-overlay'
                                                    ).addClass('vis')
                                                }}
                                            >
                                                Выбрать другой
                        ...
                        <div className="bottom-fix">
                            ...
                            {(localStorage.getItem('cookie-close') ===
                                undefined ||
                                localStorage.getItem('cookie-close') ===
                                    null) && (
