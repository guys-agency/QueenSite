                      ...
                      <div className="col col-8">
                        <div className="shop__info">
                          ...
                          <p>
                            ...
                            Богемии по самым доступным ценам. Постоянные скидки
                            и регулярные распродажи!
                            <br />
                            <br />
                            Наши покупатели оценят возможность подобрать себе
                            посуду и подарки от производителей Богемии по самым
                            доступным ценам.
                          </p>
                        </div>
                      </div>
